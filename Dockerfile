...
RUN yum update -y
RUN yum install -y vim openssh openssh-server openssh-clients sudo passwd wget tar
...
RUN chown oomatomo:oomatomo -R /home/oomatomo/.ssh
RUN chmod 700 /home/oomatomo/.ssh
